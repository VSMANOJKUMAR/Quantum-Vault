...
public class PasswordGenerator {
    ...
    public String generatePassword(int length, boolean includeUppercase,
                                   ...
                                   boolean includeSpecialSymbols, String customCharacters) {
    ...
    public String generatePassword(int length, boolean includeUppercase,
        ...
        return generatePassword(length, includeUppercase, includeLowercase,
                includeNumbers, includeSpecialSymbols, null);
    }
}